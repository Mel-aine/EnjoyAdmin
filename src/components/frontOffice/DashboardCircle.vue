<template>
  <div class="bg-white dark:bg-gray-800 p-4 w-full">
    ...
    <div class="flex gap-5 items-center justify-cent">
      <div class="flex items-center justify-center mb-4">
        <div class="relative w-24 h-24">
          ...
          <svg v-else class="w-24 h-24 transform -rotate-90" viewBox="0 0 100 100">
            ...
            <circle v-for="segment in segments" :key="segment.label" cx="50" cy="50" r="40" :stroke="segment.color"
              stroke-width="8" fill="none" stroke-linecap="butt"
