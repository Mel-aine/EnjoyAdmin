<template>
  ...
  <div class="relative" ref="dropdownRef">
    ...
    <div v-if="dropdownOpen"
      class="absolute right-0 mt-[17px] flex w-[260px]  flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark z-[100]">
      <div>
      ...
      <ul class="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
        <li v-for="item in menuItems" :key="item.href">
          <router-link :to="item.href" target="_blank" rel="noopener noreferrer"
...
<script setup>
import { UserCircleIcon, ChevronDownIcon, LogoutIcon, SettingsIcon, PlugInIcon,GridIcon  } from '@/icons'
