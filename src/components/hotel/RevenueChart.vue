<template>
    <div class="bg-white rounded-lg shadow p-6">
      <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-semibold">Revenus et statistiques</h2>
        <div class="flex space-x-2">
          <button class="px-3 py-1 text-sm rounded-full bg-blue-100 text-blue-600 font-medium">Année</button>
          <button class="px-3 py-1 text-sm rounded-full text-gray-500 hover:bg-gray-100">Semestre</button>
          <button class="px-3 py-1 text-sm rounded-full text-gray-500 hover:bg-gray-100">Trimestre</button>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-blue-50 rounded-lg p-4">
          <div class="text-blue-600 text-sm font-medium mb-1">Revenu total</div>
          <div class="text-2xl font-bold">1,283,250 €</div>
        ...
        <div class="bg-purple-50 rounded-lg p-4">
          ...
          <div class="text-2xl font-bold">155 €</div>
          <div class="flex items-center mt-2">
      ...
      <div class="flex justify-center mt-4 space-x-8">
        <div class="flex items-center">
          ...
          <span class="text-sm text-gray-600">Revenus 2025</span>
        </div>
        <div class="flex items-center">
          <div class="w-3 h-3 bg-gray-300 rounded-full mr-2"></div>
          <span class="text-sm text-gray-600">Revenus 2024</span>
        </div>
        <div class="flex items-center">
          <div class="w-1 h-4 bg-green-500 rounded-full mr-2"></div>
          <span class="text-sm text-gray-600">Taux d'occupation 2025</span>
        </div>
      </div>
    </div>
  </template>
