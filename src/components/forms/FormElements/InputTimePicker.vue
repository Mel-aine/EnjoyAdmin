  ...
  <div>
    ...
    <div class="relative">
      <flat-pickr
        ...
        :class="[
          'h-11 w-full appearance-none border border-gray-300 bg-white px-4 py-2.5 pr-11 text-sm text-gray-900 shadow-theme-xs placeholder:text-gray-500 focus:border-purple-300 focus:outline-hidden focus:ring-3 focus:ring-purple-500/10 dark:border-gray-700 dark:bg-dark-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-purple-800',
        props.customClass
        ]"
