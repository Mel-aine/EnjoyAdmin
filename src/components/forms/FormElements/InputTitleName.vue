                ...
                <div v-else class="flex-1 flex gap-0">
                    ...
                    <div class="flex-1">
                        <input v-model="lastName" type="text" :placeholder="$t('LastName')"
                            class="h-11 w-full  rounded-l-none border border-black/50 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-purple-500 focus:outline-hidden focus:ring-3 focus:ring-purple-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-purple-800 rounded-r-lg"/>
                    </div>
                </div>
            </div>
        </div>
