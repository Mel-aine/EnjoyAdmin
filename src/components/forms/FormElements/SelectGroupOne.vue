  ...
  <div>
    ...
    <div class="relative z-20 bg-white dark:bg-form-input">
      ...
      <select v-model="selectedOption" :class="{ 'text-black dark:text-white': isOptionSelected }" @change="changeTextColor" :disabled="disabled"
        class="relative z-20 w-full appearance-none rounded-lg border border-stroke bg-transparent py-2 px-12 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
