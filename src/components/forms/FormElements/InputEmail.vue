<template>
    <div>
        ...
        <div class="relative">
            <span
                class="absolute left-0 top-1/2 -translate-y-1/2 border-r border-black/50 px-3.5 py-3 text-gray-500 dark:border-gray-800 dark:text-gray-400">
