  ...
  <div class="h-full animate-pulse">
    ...
    <div class="shadow-sm px-4 py-2 mx-4 bg-white flex justify-between">
      ...
      <div class="flex gap-x-2">
        <!-- Status skeleton -->
        <div class="w-20 h-8 bg-gray-200 rounded border"></div>
      ...
      <div class="flex justify-between w-full">
        <div class="border-b border-gray-200">
          <nav class="flex space-x-8 px-6">
            <!-- Tab skeletons -->
            <div v-for="i in 5" :key="i" class="py-4 px-2">
              <div class="w-24 h-4 bg-gray-200 rounded"></div>
            </div>
          </nav>
        </div>
        <div class="align-middle self-center items-center">
          <!-- Options dropdown skeleton -->
          <div class="w-20 h-8 bg-gray-200 rounded border"></div>
        </div>
      </div>
    </div>
    ...
    <div class="mx-4 mt-4 bg-white shadow-sm rounded-lg p-6">
      ...
      <div class="space-y-6">
        ...
        <!-- Content rows -->
        <div class="space-y-4">
          <div v-for="i in 8" :key="i" class="flex justify-between items-center py-3 border-b border-gray-100">
        ...
        <!-- Table skeleton -->
        <div class="mt-8">
          <div class="w-24 h-5 bg-gray-200 rounded mb-4"></div>
          <div class="border border-gray-200 rounded-lg overflow-hidden">
            ...
            <!-- Table rows -->
            <div v-for="i in 5" :key="i" class="px-4 py-3 border-b border-gray-100 last:border-b-0">
              <div class="flex space-x-4">
                <div class="w-20 h-4 bg-gray-200 rounded"></div>
                <div class="w-24 h-4 bg-gray-200 rounded"></div>
                <div class="w-16 h-4 bg-gray-200 rounded"></div>
