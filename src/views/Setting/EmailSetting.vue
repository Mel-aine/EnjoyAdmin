    ...
    <div class="space-y-6">
      ...
      <div class="bg-gray-50 p-5 rounded-lg border border-gray-200 dark:bg-gray-950 dark:text-white">
        ...
        <div v-if="additionalEmails.length > 0" class="space-y-2 mb-3">
          <div v-for="(email, index) in additionalEmails" :key="index" class="relative lg:flex items-center justify-between p-2 bg-white border border-gray-200 rounded-md">
            <span>{{ email }}</span>
            <div class="flex gap-2">
              <button
                @click="setEmailAsPrimary(index)"
