            ...
            >
              <div class="mb-3">
                <div class="flex items-center justify-between">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      @click.prevent="decrementAdults(index)"
                      class="px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded-full hover:bg-gray-300 dark:hover:bg-gray-600"
                    >
                      -
                    </button>
                    <span class="w-6 text-center">{{ roomSelection.adults }}</span>
                    <button
                      @click.prevent="incrementAdults(index)"
                      class="px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded-full hover:bg-gray-300 dark:hover:bg-gray-600"
                    >
                      +
                    </button>
              ...
              <div class="mb-4">
                <div class="flex items-center justify-between">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      @click.prevent="decrementChildren(index)"
                      class="px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded-full hover:bg-gray-300 dark:hover:bg-gray-600"
                    >
                      -
                    </button>
                    ...
                    <button
                      @click.prevent="incrementChildren(index)"
                      class="px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded-full hover:bg-gray-300 dark:hover:bg-gray-600"
                    >
                      +
                    </button>
...
export default {
  ...
  data() {
    return {
      roomSelections: this.initialRoomSelections.length
        ? this.initialRoomSelections
        : [this.createEmptyRoomSelection()],
      flatpickrConfig: {
        dateFormat: 'd/m/Y',
        minDate: 'today',
        mode: 'single',
  ...
  methods: {
    ...
    incrementAdults(index) {
      const selectedRoom = this.availableRooms.find(
        (room) => room.id === this.roomSelections[index].roomType,
      )
