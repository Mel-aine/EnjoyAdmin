              ...
              <div class="grid md:grid-cols-4 grid-cols-1 gap-4">
                ...
                <div>
                  <Select
                    ...
                    :options="BookingType"
                    :placeholder="$t('SelectReservationType')"
                  />
                </div>
                ...
                <div>
                  <Select
                    ...
                    :placeholder="$t('SelectBookingSource')"
                  />
                </div>
                ...
                <div class="space-y-3">
                  <div>
                    ...
                    <div v-if="otherInfo.emailBookingVouchers" class="flex space-x-2 pl-6">
                      ...
                      <div
                        class="flex flex-col h-full justify-center align-middle self-center mt-2"
                      >
                        <BasicButton
                          :label="$t('otherInfo.previewVoucher')"
                          variant="dark"
                        ></BasicButton>
                      </div>
                    </div>
          ...
          >
            ...
            <div class="flex space-x-3">
              <BasicButton
                ...
                type="button"
                @click="openCheckInReservationModal"
                :label="$t('Check-In')"
              >
              </BasicButton>
              <BasicButton
