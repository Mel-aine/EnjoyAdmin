        ...
        <div class="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-4 gap-6 mt-3">
                ...
                <div>
                 ...
                 <div>
                    <Input :lb="$t('children')" :inputType="'Number'" :placeholder="$t('children')"
                        :id="'children'" :forLabel="'children'" v-model="localRoomSelection.children" :min="0" />
                </div>
                <div>
                ...
                <div class="space-y-2">
                    ...
                    <div v-if="(localRoomSelection.default_deposit ?? 0) > 0" class="flex justify-between items-center">
                        ...
                        <span class="text-green-600 dark:text-green-400 font-medium">
                            {{ formatCurrency((localRoomSelection.default_deposit ?? 0)*localRoomSelection.numberOfNights) }}
                        </span>
                    </div>
                </div>
            </div>
...
const availableRoomsByType = computed(() => {
    return props.availableRooms.filter((room) => {
        ...
        console.log('matchesType', room);
        console.log('localRoomSelection.value.roomTypeSelect', localRoomSelection.value.roomTypeSelect);
...
watch(() => localRoomSelection.value.roomType, (newType) => {
