    ...
    <div class="p-6">
      <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400">
          {{ $t('viewAndManageGuestFolioInformation') }}
        </p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <InputDatepicker v-model="filters.dateFrom" :placeholder="$t('From')" class="w-full" />
          </div>
          ...
          <div>
            ...
            <InputDatepicker v-model="filters.dateTo" :placeholder="$t('To')" class="w-full" />
          </div>
          ...
          <div>
            ...
            <SelectComponent v-model="filters.businessSource" :options="businessSourceOptions" :placeholder="$t('selectBusinessSource')" class="w-full" />
          </div>
        </div>
...
const hotelName = computed(() => {
  return useServiceStore().getCurrentService?.hotelName || t('hotelName')
})
  ...
  try {
    ...
    if (response && response.data && response.success) {
      ...
      folioData.value = folios.map((folio: any) => ({
        ...
        invoiceNo: folio.invoiceNo || t('notAvailable'),
        date: folio.date,
        pax: folio.pax,
        name: folio.name,
        status: folio.status,
