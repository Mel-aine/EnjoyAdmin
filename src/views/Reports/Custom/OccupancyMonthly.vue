    ...
    <div class="occupancy-rate-report">
      ...
      <div class="bg-white  dark:bg-gray-800 shadow-sm border-b border-gray-200 px-6 py-4">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $t('monthlyOccupancyRateReport') }}</h1>
...
/**
 * OccupancyRate Component
 * 
 * A comprehensive occupancy rate reporting component that displays monthly
 * occupancy statistics in PDF format using the EnjoyPDFView component.
 * 
 * Features:
...
const generateReport = async () => {
  try {
    ...
    // Validate parameters
    validateMonthlyOccupancyParams(currentParams.value)
