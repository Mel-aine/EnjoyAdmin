          ...
          <div class="flex flex-col sm:flex-row sm:items-center sm:space-x-2 w-full sm:w-auto">
            ...
            <div class="relative w-full sm:w-auto">
              <input
                ...
                class="border border-gray-300 dark:border-gray-700 rounded px-3 py-1.5 pr-8 w-full sm:w-64 text-sm block leading-5 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-purple-500 focus:border-purple-500"
                v-model="searchQuery"
              />
              <SearchIcon
                :size="16"
